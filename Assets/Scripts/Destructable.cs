    ...
    private void Drop()
    {
        ...
        switch (rand)
        {
            ...
            case 0:
                ...
                gem.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 1:
                ...
                gem1.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 2:
                ...
                gem2.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 3:
                ...
                gem3.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 4:
                ...
                gem4.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 5:
                ...
                gem5.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 6:
                ...
                gem6.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 7:
                ...
                gem7.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 8:
                ...
                gem8.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 9:
                ...
                gem9.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 10:
                ...
                gem10.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
            ...
            case 11:
                ...
                gem11.GetComponent<Rigidbody>().AddForce(new Vector3(-transform.position.x, -transform.position.y, 0.1f).normalized * 20f);
